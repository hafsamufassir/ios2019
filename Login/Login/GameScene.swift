...
class GameScene: SKScene,UITextFieldDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        usernameTextField.addTarget(self, action:#selector(GameScene.textFieldDidChange(textField:)), for: UIControl.Event.editingChanged)
        ...
        //buttons
        let myBlue = SKColor(red: 59/255, green: 89/255, blue: 153/255, alpha: 1)
        ...
        let myCyan = SKColor(red: 85/255, green: 172/255, blue: 239/255, alpha: 1)
